            ...
            <div class="duru-wrap-inner">
                <nav class="duru-menu">
                    <ul>
                        ...
                        <li class='duru-menu-sub active'><a href='#'>Projects <i class="ti-angle-down"></i></a>
                            <ul>
                                <li class="active"><a href='projects.html'>Projects 01</a></li>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                            <div class="items mb-4">
                                <div class="con">
                                    <div class="img">
                                        <img src="images/projects/07.jpg" alt="">
                                    </div>
                                    <div class="info">
                    ...
                    <div class="col-lg-4 col-md-6">
                            <div class="items mb-4">
                                <div class="con">
                                    <div class="img">
                                        <img src="images/projects/08.jpg" alt="">
                                    </div>
                                    <div class="info">
                    ...
                    <div class="col-lg-4 col-md-6">
                            <div class="items mb-4">
                                <div class="con">
                                    <div class="img">
                                        <img src="images/projects/09.jpg" alt="">
                                    </div>
                                    <div class="info">
